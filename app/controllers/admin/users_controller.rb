module Admin
  class UsersController < AdminController
    ...
    before_action :fetch_user_detail, only: %I[user_service_request partner_service_request destroy partner_details]
    before_action :params_page, only: %I[user_service_request partner_service_request service_requests_list]
    layout 'admin'
    def index
