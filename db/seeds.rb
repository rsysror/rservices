...
Country.create(:id=>1,:code=>"AD",:name=>"Andorra")
Country.create(:id=>2,:code=>"AE",:name=>"United Arab Emirates")
Country.create(:id=>3,:code=>"AF",:name=>"Afghanistan")
Country.create(:id=>4,:code=>"AG",:name=>"Antigua and Barbuda")
Country.create(:id=>5,:code=>"AI",:name=>"Anguilla")
Country.create(:id=>6,:code=>"AL",:name=>"Albania")
Country.create(:id=>7,:code=>"AM",:name=>"Armenia")
Country.create(:id=>8,:code=>"AO",:name=>"Angola")
Country.create(:id=>9,:code=>"AQ",:name=>"Antarctica")
Country.create(:id=>10,:code=>"AR",:name=>"Argentina")
Country.create(:id=>11,:code=>"AS",:name=>"American Samoa")
Country.create(:id=>12,:code=>"AT",:name=>"Austria")
Country.create(:id=>13,:code=>"AU",:name=>"Australia")
Country.create(:id=>14,:code=>"AW",:name=>"Aruba")
Country.create(:id=>15,:code=>"AX",:name=>"Aland Islands")
Country.create(:id=>16,:code=>"AZ",:name=>"Azerbaijan")
Country.create(:id=>17,:code=>"BA",:name=>"Bosnia and Herzegovina")
Country.create(:id=>18,:code=>"BB",:name=>"Barbados")
Country.create(:id=>19,:code=>"BD",:name=>"Bangladesh")
Country.create(:id=>20,:code=>"BE",:name=>"Belgium")
Country.create(:id=>21,:code=>"BF",:name=>"Burkina Faso")
Country.create(:id=>22,:code=>"BG",:name=>"Bulgaria")
Country.create(:id=>23,:code=>"BH",:name=>"Bahrain")
Country.create(:id=>24,:code=>"BI",:name=>"Burundi")
Country.create(:id=>25,:code=>"BJ",:name=>"Benin")
Country.create(:id=>26,:code=>"BL",:name=>"Saint Barthelemy")
Country.create(:id=>27,:code=>"BM",:name=>"Bermuda")
Country.create(:id=>28,:code=>"BN",:name=>"Brunei")
Country.create(:id=>29,:code=>"BO",:name=>"Bolivia")
Country.create(:id=>30,:code=>"BQ",:name=>"Bonaire, Saint Eustatius and Saba ")
Country.create(:id=>31,:code=>"BR",:name=>"Brazil")
Country.create(:id=>32,:code=>"BS",:name=>"Bahamas")
Country.create(:id=>33,:code=>"BT",:name=>"Bhutan")
Country.create(:id=>34,:code=>"BV",:name=>"Bouvet Island")
Country.create(:id=>35,:code=>"BW",:name=>"Botswana")
Country.create(:id=>36,:code=>"BY",:name=>"Belarus")
Country.create(:id=>37,:code=>"BZ",:name=>"Belize")
Country.create(:id=>38,:code=>"CA",:name=>"Canada")
Country.create(:id=>39,:code=>"CC",:name=>"Cocos Islands")
Country.create(:id=>40,:code=>"CD",:name=>"Democratic Republic of the Congo")
Country.create(:id=>41,:code=>"CF",:name=>"Central African Republic")
Country.create(:id=>42,:code=>"CG",:name=>"Republic of the Congo")
Country.create(:id=>43,:code=>"CH",:name=>"Switzerland")
Country.create(:id=>44,:code=>"CI",:name=>"Ivory Coast")
Country.create(:id=>45,:code=>"CK",:name=>"Cook Islands")
Country.create(:id=>46,:code=>"CL",:name=>"Chile")
Country.create(:id=>47,:code=>"CM",:name=>"Cameroon")
Country.create(:id=>48,:code=>"CN",:name=>"China")
Country.create(:id=>49,:code=>"CO",:name=>"Colombia")
Country.create(:id=>50,:code=>"CR",:name=>"Costa Rica")
Country.create(:id=>51,:code=>"CU",:name=>"Cuba")
Country.create(:id=>52,:code=>"CV",:name=>"Cape Verde")
Country.create(:id=>53,:code=>"CW",:name=>"Curacao")
Country.create(:id=>54,:code=>"CX",:name=>"Christmas Island")
Country.create(:id=>55,:code=>"CY",:name=>"Cyprus")
Country.create(:id=>56,:code=>"CZ",:name=>"Czech Republic")
Country.create(:id=>57,:code=>"DE",:name=>"Germany")
Country.create(:id=>58,:code=>"DJ",:name=>"Djibouti")
Country.create(:id=>59,:code=>"DK",:name=>"Denmark")
Country.create(:id=>60,:code=>"DM",:name=>"Dominica")
Country.create(:id=>61,:code=>"DO",:name=>"Dominican Republic")
Country.create(:id=>62,:code=>"DZ",:name=>"Algeria")
Country.create(:id=>63,:code=>"EC",:name=>"Ecuador")
Country.create(:id=>64,:code=>"EE",:name=>"Estonia")
Country.create(:id=>65,:code=>"EG",:name=>"Egypt")
Country.create(:id=>66,:code=>"EH",:name=>"Western Sahara")
Country.create(:id=>67,:code=>"ER",:name=>"Eritrea")
Country.create(:id=>68,:code=>"ES",:name=>"Spain")
Country.create(:id=>69,:code=>"ET",:name=>"Ethiopia")
Country.create(:id=>70,:code=>"FI",:name=>"Finland")
Country.create(:id=>71,:code=>"FJ",:name=>"Fiji")
Country.create(:id=>72,:code=>"FK",:name=>"Falkland Islands")
Country.create(:id=>73,:code=>"FM",:name=>"Micronesia")
Country.create(:id=>74,:code=>"FO",:name=>"Faroe Islands")
Country.create(:id=>75,:code=>"FR",:name=>"France")
Country.create(:id=>76,:code=>"GA",:name=>"Gabon")
Country.create(:id=>77,:code=>"GB",:name=>"United Kingdom")
Country.create(:id=>78,:code=>"GD",:name=>"Grenada")
Country.create(:id=>79,:code=>"GE",:name=>"Georgia")
Country.create(:id=>80,:code=>"GF",:name=>"French Guiana")
Country.create(:id=>81,:code=>"GG",:name=>"Guernsey")
Country.create(:id=>82,:code=>"GH",:name=>"Ghana")
Country.create(:id=>83,:code=>"GI",:name=>"Gibraltar")
Country.create(:id=>84,:code=>"GL",:name=>"Greenland")
Country.create(:id=>85,:code=>"GM",:name=>"Gambia")
Country.create(:id=>86,:code=>"GN",:name=>"Guinea")
Country.create(:id=>87,:code=>"GP",:name=>"Guadeloupe")
Country.create(:id=>88,:code=>"GQ",:name=>"Equatorial Guinea")
Country.create(:id=>89,:code=>"GR",:name=>"Greece")
Country.create(:id=>90,:code=>"GS",:name=>"South Georgia and the South Sandwich Islands")
Country.create(:id=>91,:code=>"GT",:name=>"Guatemala")
Country.create(:id=>92,:code=>"GU",:name=>"Guam")
Country.create(:id=>93,:code=>"GW",:name=>"Guinea-Bissau")
Country.create(:id=>94,:code=>"GY",:name=>"Guyana")
Country.create(:id=>95,:code=>"HK",:name=>"Hong Kong")
Country.create(:id=>96,:code=>"HM",:name=>"Heard Island and McDonald Islands")
Country.create(:id=>97,:code=>"HN",:name=>"Honduras")
Country.create(:id=>98,:code=>"HR",:name=>"Croatia")
Country.create(:id=>99,:code=>"HT",:name=>"Haiti")
Country.create(:id=>100,:code=>"HU",:name=>"Hungary")
Country.create(:id=>101,:code=>"ID",:name=>"Indonesia")
Country.create(:id=>102,:code=>"IE",:name=>"Ireland")
Country.create(:id=>103,:code=>"IL",:name=>"Israel")
Country.create(:id=>104,:code=>"IM",:name=>"Isle of Man")
Country.create(:id=>105,:code=>"IN",:name=>"India")
Country.create(:id=>106,:code=>"IO",:name=>"British Indian Ocean Territory")
Country.create(:id=>107,:code=>"IQ",:name=>"Iraq")
Country.create(:id=>108,:code=>"IR",:name=>"Iran")
Country.create(:id=>109,:code=>"IS",:name=>"Iceland")
Country.create(:id=>110,:code=>"IT",:name=>"Italy")
Country.create(:id=>111,:code=>"JE",:name=>"Jersey")
Country.create(:id=>112,:code=>"JM",:name=>"Jamaica")
Country.create(:id=>113,:code=>"JO",:name=>"Jordan")
Country.create(:id=>114,:code=>"JP",:name=>"Japan")
Country.create(:id=>115,:code=>"KE",:name=>"Kenya")
Country.create(:id=>116,:code=>"KG",:name=>"Kyrgyzstan")
Country.create(:id=>117,:code=>"KH",:name=>"Cambodia")
Country.create(:id=>118,:code=>"KI",:name=>"Kiribati")
Country.create(:id=>119,:code=>"KM",:name=>"Comoros")
Country.create(:id=>120,:code=>"KN",:name=>"Saint Kitts and Nevis")
Country.create(:id=>121,:code=>"KP",:name=>"North Korea")
Country.create(:id=>122,:code=>"KR",:name=>"South Korea")
Country.create(:id=>123,:code=>"XK",:name=>"Kosovo")
Country.create(:id=>124,:code=>"KW",:name=>"Kuwait")
Country.create(:id=>125,:code=>"KY",:name=>"Cayman Islands")
Country.create(:id=>126,:code=>"KZ",:name=>"Kazakhstan")
Country.create(:id=>127,:code=>"LA",:name=>"Laos")
Country.create(:id=>128,:code=>"LB",:name=>"Lebanon")
Country.create(:id=>129,:code=>"LC",:name=>"Saint Lucia")
Country.create(:id=>130,:code=>"LI",:name=>"Liechtenstein")
Country.create(:id=>131,:code=>"LK",:name=>"Sri Lanka")
Country.create(:id=>132,:code=>"LR",:name=>"Liberia")
Country.create(:id=>133,:code=>"LS",:name=>"Lesotho")
Country.create(:id=>134,:code=>"LT",:name=>"Lithuania")
Country.create(:id=>135,:code=>"LU",:name=>"Luxembourg")
Country.create(:id=>136,:code=>"LV",:name=>"Latvia")
Country.create(:id=>137,:code=>"LY",:name=>"Libya")
Country.create(:id=>138,:code=>"MA",:name=>"Morocco")
Country.create(:id=>139,:code=>"MC",:name=>"Monaco")
Country.create(:id=>140,:code=>"MD",:name=>"Moldova")
Country.create(:id=>141,:code=>"ME",:name=>"Montenegro")
Country.create(:id=>142,:code=>"MF",:name=>"Saint Martin")
Country.create(:id=>143,:code=>"MG",:name=>"Madagascar")
Country.create(:id=>144,:code=>"MH",:name=>"Marshall Islands")
Country.create(:id=>145,:code=>"MK",:name=>"Macedonia")
Country.create(:id=>146,:code=>"ML",:name=>"Mali")
Country.create(:id=>147,:code=>"MM",:name=>"Myanmar")
Country.create(:id=>148,:code=>"MN",:name=>"Mongolia")
Country.create(:id=>149,:code=>"MO",:name=>"Macao")
Country.create(:id=>150,:code=>"MP",:name=>"Northern Mariana Islands")
Country.create(:id=>151,:code=>"MQ",:name=>"Martinique")
Country.create(:id=>152,:code=>"MR",:name=>"Mauritania")
Country.create(:id=>153,:code=>"MS",:name=>"Montserrat")
Country.create(:id=>154,:code=>"MT",:name=>"Malta")
Country.create(:id=>155,:code=>"MU",:name=>"Mauritius")
Country.create(:id=>156,:code=>"MV",:name=>"Maldives")
Country.create(:id=>157,:code=>"MW",:name=>"Malawi")
Country.create(:id=>158,:code=>"MX",:name=>"Mexico")
Country.create(:id=>159,:code=>"MY",:name=>"Malaysia")
Country.create(:id=>160,:code=>"MZ",:name=>"Mozambique")
Country.create(:id=>161,:code=>"NA",:name=>"Namibia")
Country.create(:id=>162,:code=>"NC",:name=>"New Caledonia")
Country.create(:id=>163,:code=>"NE",:name=>"Niger")
Country.create(:id=>164,:code=>"NF",:name=>"Norfolk Island")
Country.create(:id=>165,:code=>"NG",:name=>"Nigeria")
Country.create(:id=>166,:code=>"NI",:name=>"Nicaragua")
Country.create(:id=>167,:code=>"NL",:name=>"Netherlands")
Country.create(:id=>168,:code=>"NO",:name=>"Norway")
Country.create(:id=>169,:code=>"NP",:name=>"Nepal")
Country.create(:id=>170,:code=>"NR",:name=>"Nauru")
Country.create(:id=>171,:code=>"NU",:name=>"Niue")
Country.create(:id=>172,:code=>"NZ",:name=>"New Zealand")
Country.create(:id=>173,:code=>"OM",:name=>"Oman")
Country.create(:id=>174,:code=>"PA",:name=>"Panama")
Country.create(:id=>175,:code=>"PE",:name=>"Peru")
Country.create(:id=>176,:code=>"PF",:name=>"French Polynesia")
Country.create(:id=>177,:code=>"PG",:name=>"Papua New Guinea")
Country.create(:id=>178,:code=>"PH",:name=>"Philippines")
Country.create(:id=>179,:code=>"PK",:name=>"Pakistan")
Country.create(:id=>180,:code=>"PL",:name=>"Poland")
Country.create(:id=>181,:code=>"PM",:name=>"Saint Pierre and Miquelon")
Country.create(:id=>182,:code=>"PN",:name=>"Pitcairn")
Country.create(:id=>183,:code=>"PR",:name=>"Puerto Rico")
Country.create(:id=>184,:code=>"PS",:name=>"Palestinian Territory")
Country.create(:id=>185,:code=>"PT",:name=>"Portugal")
Country.create(:id=>186,:code=>"PW",:name=>"Palau")
Country.create(:id=>187,:code=>"PY",:name=>"Paraguay")
Country.create(:id=>188,:code=>"QA",:name=>"Qatar")
Country.create(:id=>189,:code=>"RE",:name=>"Reunion")
Country.create(:id=>190,:code=>"RO",:name=>"Romania")
Country.create(:id=>191,:code=>"RS",:name=>"Serbia")
Country.create(:id=>192,:code=>"RU",:name=>"Russia")
Country.create(:id=>193,:code=>"RW",:name=>"Rwanda")
Country.create(:id=>194,:code=>"SA",:name=>"Saudi Arabia")
Country.create(:id=>195,:code=>"SB",:name=>"Solomon Islands")
Country.create(:id=>196,:code=>"SC",:name=>"Seychelles")
Country.create(:id=>197,:code=>"SD",:name=>"Sudan")
Country.create(:id=>198,:code=>"SE",:name=>"Sweden")
Country.create(:id=>199,:code=>"SG",:name=>"Singapore")
Country.create(:id=>200,:code=>"SH",:name=>"Saint Helena")
Country.create(:id=>201,:code=>"SI",:name=>"Slovenia")
Country.create(:id=>202,:code=>"SJ",:name=>"Svalbard and Jan Mayen")
Country.create(:id=>203,:code=>"SK",:name=>"Slovakia")
Country.create(:id=>204,:code=>"SL",:name=>"Sierra Leone")
Country.create(:id=>205,:code=>"SM",:name=>"San Marino")
Country.create(:id=>206,:code=>"SN",:name=>"Senegal")
Country.create(:id=>207,:code=>"SO",:name=>"Somalia")
Country.create(:id=>208,:code=>"SR",:name=>"Suriname")
Country.create(:id=>209,:code=>"ST",:name=>"Sao Tome and Principe")
Country.create(:id=>210,:code=>"SV",:name=>"El Salvador")
Country.create(:id=>211,:code=>"SX",:name=>"Sint Maarten")
Country.create(:id=>212,:code=>"SY",:name=>"Syria")
Country.create(:id=>213,:code=>"SZ",:name=>"Swaziland")
Country.create(:id=>214,:code=>"TC",:name=>"Turks and Caicos Islands")
Country.create(:id=>215,:code=>"TD",:name=>"Chad")
Country.create(:id=>216,:code=>"TF",:name=>"French Southern Territories")
Country.create(:id=>217,:code=>"TG",:name=>"Togo")
Country.create(:id=>218,:code=>"TH",:name=>"Thailand")
Country.create(:id=>219,:code=>"TJ",:name=>"Tajikistan")
Country.create(:id=>220,:code=>"TK",:name=>"Tokelau")
Country.create(:id=>221,:code=>"TL",:name=>"East Timor")
Country.create(:id=>222,:code=>"TM",:name=>"Turkmenistan")
Country.create(:id=>223,:code=>"TN",:name=>"Tunisia")
Country.create(:id=>224,:code=>"TO",:name=>"Tonga")
Country.create(:id=>225,:code=>"TR",:name=>"Turkey")
Country.create(:id=>226,:code=>"TT",:name=>"Trinidad and Tobago")
Country.create(:id=>227,:code=>"TV",:name=>"Tuvalu")
Country.create(:id=>228,:code=>"TW",:name=>"Taiwan")
Country.create(:id=>229,:code=>"TZ",:name=>"Tanzania")
Country.create(:id=>230,:code=>"UA",:name=>"Ukraine")
Country.create(:id=>231,:code=>"UG",:name=>"Uganda")
Country.create(:id=>232,:code=>"UM",:name=>"United States Minor Outlying Islands")
Country.create(:id=>233,:code=>"US",:name=>"United States")
Country.create(:id=>234,:code=>"UY",:name=>"Uruguay")
Country.create(:id=>235,:code=>"UZ",:name=>"Uzbekistan")
Country.create(:id=>236,:code=>"VA",:name=>"Vatican")
Country.create(:id=>237,:code=>"VC",:name=>"Saint Vincent and the Grenadines")
Country.create(:id=>238,:code=>"VE",:name=>"Venezuela")
Country.create(:id=>239,:code=>"VG",:name=>"British Virgin Islands")
Country.create(:id=>240,:code=>"VI",:name=>"U.S. Virgin Islands")
Country.create(:id=>241,:code=>"VN",:name=>"Vietnam")
Country.create(:id=>242,:code=>"VU",:name=>"Vanuatu")
Country.create(:id=>243,:code=>"WF",:name=>"Wallis and Futuna")
Country.create(:id=>244,:code=>"WS",:name=>"Samoa")
Country.create(:id=>245,:code=>"YE",:name=>"Yemen")
Country.create(:id=>246,:code=>"YT",:name=>"Mayotte")
Country.create(:id=>247,:code=>"ZA",:name=>"South Africa")
Country.create(:id=>248,:code=>"ZM",:name=>"Zambia")
Country.create(:id=>249,:code=>"ZW",:name=>"Zimbabwe")
Country.create(:id=>250,:code=>"CS",:name=>"Serbia and Montenegro")
Country.create(:id=>251,:code=>"AN",:name=>"Netherlands Antilles")

State.delete_all
p "Importing State of countries."
...
State.create(:id=>3477, :name=>"Wa", :country_id=>231)
